                ...
                <div class="card-body p-5">
                    <form method="POST" action="{{ route('transaksi.store') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="jumlah" class="form-control shadow-sm" placeholder="Masukkan jumlah pesanan" required>
                        </div>

                        <!-- Tanggal -->
                        <div class="mb-4">
                            <label class="form-label fw-semibold">Tanggal</label>
                            <input type="datetime-local" name="tanggal" class="form-control shadow-sm" required>
                        </div>
